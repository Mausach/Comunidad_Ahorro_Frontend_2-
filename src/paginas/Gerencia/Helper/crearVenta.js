...
export const starCrearVentaCliente = async (newUser,setRefreshData, navigate) => {
    try {
        const resp = await authApi.post('/ventas/new-venta', newUser);

        Swal.fire({
            title: "Venta creada",
            text: "La venta ha sido creado exitosamente.",
            icon: "success",
            background: "#f9f9f9",
